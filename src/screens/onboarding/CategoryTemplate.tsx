    ...
    >
      <div className="bg-white pb-4 shadow-sm z-10">
        <Header 
            ...
            totalSteps={4}
            title={
                <span>カテゴリを<br/> <span className="relative">選択<span className="absolute bottom-1 left-0 w-full h-3 bg-primary/20 -z-10 -rotate-1"></span></span></span>
            }
            subtitle="よく使うカテゴリテンプレートを選んでください"
        />
      </div>
      ...
      <div className="absolute bottom-0 w-full bg-white/90 backdrop-blur-md border-t border-gray-100 p-6 z-20">
        ...
        <Button onClick={() => navigate('/')} icon="arrow_forward">アプリを開始</Button>
      </div>
    </motion.div>
  );
};

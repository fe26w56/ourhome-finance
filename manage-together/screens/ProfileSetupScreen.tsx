  ...
  return (
    ...
    >
      <Header 
        ...
        totalSteps={4}
        title="Who is this?"
        subtitle="Add a photo so your housemates know who to blame for the snacks."
      />
      ...
      <div className="flex-1 px-6 py-4 flex flex-col items-center overflow-y-auto no-scrollbar">
        ...
        <div className="w-full space-y-8">
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-dark ml-1">Display Name</label>
      ...
      <div className="p-6 bg-white border-t border-gray-50">
        <Button onClick={() => navigate('/template-selection')}>Next</Button>
      </div>
    </motion.div>
  );
};
